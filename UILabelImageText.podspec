...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UILabelImageText.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chenwuqi/UILabelImageText'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chenwuqi' => '925769607@qq.com' }
  s.source           = { :git => 'https://github.com/chenwuqi/UILabelImageText.git', :tag => s.version.to_s }
